...
#            print(lines)
            ...
            if line_counter%2 == 1:
                ...
                call = 'exonerate --model protein2genome --refine full --score 250 --bestn 1 --showvulgar no --showalignment FALSE --showsugar FALSE --showtargetgff TRUE ' + prt + ' temp_seq.fasta > ' + exonerate_file
                os.system(call)
